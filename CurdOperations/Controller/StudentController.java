...
public class StudentController {
	...
	@PostMapping("/save")
	public String saveStudent(@Valid StudentRequestDTO studentRequest, BindingResult bindingResult) throws IOException
		 {
		...
		logger.info(
				"Student saved successfully: " + studentRequest.getFirstName() + " " + studentRequest.getLastName());
		return "redirect:/page/1";

	}
	@GetMapping("page/{pageNo}")
	public String printStudentsList(@PathVariable(value = "pageNo") int pageNo,
	...
	public String showFormForUpdate(@RequestParam("studentid") Long id, Model themodel) {
		...
		themodel.addAttribute("photoPath", "/uploads/" + thestudent.getStudentphoto());
		themodel.addAttribute("studentRequestDTO", studentRequestDTO);
	...
	public String saveStudentUpdatedData(@Valid StudentRequestDTO studentRequestDTO, BindingResult theBindingResult) throws IOException {
		...
		if (theBindingResult.hasErrors()) {
			...
			logger.info("Student updated successfully: " + studentRequestDTO.getFirstName() + " "
